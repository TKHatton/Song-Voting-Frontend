    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="h-16 flex items-center gap-4">
        ...
        {/* pill CTA on the right */}
          ...
          className="shrink-0 inline-flex items-center rounded-full border-2 px-4 lg:px-6 py-2 text-[10px] lg:text-sm font-extrabold tracking-wider
                     border-teal-400 text-teal-300 hover:bg-teal-400 hover:text-black transition
                     ring-1 ring-teal-400/30 whitespace-nowrap"
        >
